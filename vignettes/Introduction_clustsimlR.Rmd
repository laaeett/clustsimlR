...
Some users might prefer a GUI-based approach to using the package. `clustsimlR` offers a Shiny app that allows users to explore the functionality of the package in an interactive way. To launch the app, you can run the following command:

```{r, eval=FALSE}
run_clustsimlR()
```

Note that the app offers limited functionality in terms of customisation of your analysis. However, it offers a simple and straightforward experience, especially to users who may be less familiar with R programming. 
