...
#' cellular perturbation response data. Nucleic Acids Research,
...
#' immunofluorescence method. Nature Communications, 6(1), 8390.
#' https://doi.org/10.1038/ncomms9390
#'
#' Kantarjian, H., Jabbour, E., Grimley, J., & Kirkpatrick, P. (2006).
#' Dasatinib. Nature Reviews Drug Discovery, 5(9), 717–718.
